...
## LEDs
#set_property PACKAGE_PIN U16 [get_ports {display_out[6]}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {display_out[6]}]
#set_property PACKAGE_PIN E19 [get_ports {display_out[5]}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {display_out[5]}]
#set_property PACKAGE_PIN U19 [get_ports {display_out[4]}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {display_out[4]}]
#set_property PACKAGE_PIN V19 [get_ports {display_out[3]}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {display_out[3]}]
#set_property PACKAGE_PIN W18 [get_ports {display_out[2]}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {display_out[2]}]
#set_property PACKAGE_PIN U15 [get_ports {display_out[1]}]
